...
const ParticipantsTabHead = forwardRef((props, ref) => <AnalyticsTabHead {...props}
    ref={ref}
    title='Participants' icon={<CheckCircleIcon color='green' />}
...
function OverviewCharts() {
    ...
    return <Box sx={styles.container}>
        <Tabs value={value} onChange={handleChange}>
            ...
            <Tab component={ParticipantsTabHead} id='tab-2' />
